...
export default function ToernberichtePage() {
  return (
    <main style={{ paddingTop: '72px' }}>
      <SEO
        title="Törnberichte – Reiseberichte unserer Segeltörns | Yacht-Urlaub"
        description="Authentische Törnberichte unserer Gäste und Skipper: Karibik, Kroatien, Griechenland, Balearen, Sizilien, Sardinien, Kuba und mehr."
      ...
      <div style={{ background: 'var(--navy)', padding: '4rem 0 3.5rem' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: '0.95rem', maxWidth: '520px', margin: '0 auto' }}>
            Authentische Reiseberichte unserer Törns — von der Karibik bis Kroatien, im Original-Tagebuchstil.
          </p>
        </div>
      </div>
        ...
        <div className="container">
          <div className="tb-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {toernberichte.map((tb, i) => (
              ...
              >
                <Link to={`/toernberichte/${tb.slug}`} style={{ display: 'block', height: '200px', overflow: 'hidden' }}>
                  <img
                    src={tb.cardImg}
                    alt={tb.title}
                    loading="lazy"
