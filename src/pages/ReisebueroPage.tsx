...
export default function ReisebueroPage() {
  ...
  return (
    <main style={{ paddingTop: '72px' }}>
      <SEO
        title="Für Reisebüros / Affiliate-Partner | Yacht-Urlaub"
      ...
      <div style={{ background: 'var(--navy)', padding: '4.5rem 0 4rem' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <h1 style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 'clamp(1.8rem, 4.5vw, 2.8rem)', color: '#fff', marginBottom: '1rem' }}>
            Für Reisebüros / Affiliate-Partner
          </h1>
        </div>
      </div>
      ...
      <section style={{ background: 'var(--gray-light)', padding: '4rem 0' }}>
        <div className="container" style={{ maxWidth: '640px' }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <h2 style={{ fontFamily: 'DM Sans, sans-serif', color: 'var(--navy)', fontSize: '1.4rem', marginBottom: '1rem' }}>Partner werden</h2>
            <p style={{ color: '#444', fontSize: '0.97rem', lineHeight: 1.85, marginBottom: '2.5rem' }}>
              Sie sind von unseren Produkten begeistert und möchten diese auch Ihren Kunden anbieten?
              Wir bieten attraktive Konditionen und auch automatisierte Buchungsprozesse an.
            </p>

            <h2 style={{ fontFamily: 'DM Sans, sans-serif', color: 'var(--navy)', fontSize: '1.25rem', marginBottom: '1.5rem' }}>Kontaktieren Sie uns!</h2>
            {sent ? (
            ...
            <div style={{ marginTop: '2.5rem', textAlign: 'center', color: 'var(--gray)', fontSize: '0.9rem' }}>
              <p style={{ fontWeight: 700, color: 'var(--navy)', marginBottom: '0.3rem' }}>Rufen Sie uns an! Wir beraten Sie gerne</p>
              <p>
