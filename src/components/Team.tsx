        ...
        <div className="team-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem', marginBottom: '4rem' }}>
          {team.map((t, i) => (
            ...
            >
              ...
              <h3 style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.1rem', color: 'var(--navy)', marginBottom: '0.3rem' }}>{t.name}</h3>
          ...
          {cards.map((c, i) => (
            ...
            >
              ...
              <div style={{ position: 'absolute', bottom: 0, padding: '1.5rem' }}>
                <h3 style={{ color: '#fff', fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: '0.5rem' }}>{c.title}</h3>
