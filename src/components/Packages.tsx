...
export const packages: Package[] = [
  // ─────────────────────────────────── DALMATIEN ───────────────────────────────────
  {
    ...
    gallery: [
      ...
      { src: '/images/packages/dalmatien/gallery/WP_20150818_003.webp', alt: 'Gemeinsames Abendessen in Vis' },
      { src: '/images/packages/dalmatien/gallery/milna.jpg', alt: 'Milna auf Brac' },
      { src: '/images/Zielgruppen/Sunset Hula Hula.webp', alt: 'Sonnenuntergang in der Hula Hula Bar in Hvar' },
      ...
      { src: '/images/packages/dalmatien/gallery/Split 1.webp', alt: 'Hafenkai von Split' },
  ...
  // ─────────────────────────────────── KARIBIK BVI ───────────────────────────────────
  {
    ...
    gallery: [
      ...
      { src: '/images/packages/Karibik-BVI/gallery/1495014128.webp', alt: 'Schnorchlerin unter Wasser vor einer Felsküste in der Karibik' },
      { src: '/images/packages/Karibik-BVI/gallery/Indians.jpg', alt: 'The Indians' },
      { src: '/images/packages/Karibik-BVI/gallery/DSC_1149_279.webp', alt: 'Piratenmusiker unterhält Gäste in der Willy T’s Bar' },
      { src: '/images/packages/Karibik-BVI/gallery/DSC_1180_309.webp', alt: 'Gast hebt Muschel und Rum-Flasche in die Höhe in der Willy T’s Bar' },
      { src: '/images/packages/Karibik-BVI/gallery/Sandy Cay.jpg', alt: 'Sandy Cay' },
      { src: '/images/packages/Karibik-BVI/gallery/14950141218.jpg', alt: 'Ankernde Segelyachten in einer türkisblauen Bucht mit weißem Sandstrand' },
      { src: '/images/packages/Karibik-BVI/gallery/Willie Ts.webp', alt: 'Willy T’s' },
      { src: '/images/packages/Karibik-BVI/gallery/Willy_T_T-Shirt.jpg', alt: 'Willy T T-Shirt' },
      { src: '/images/packages/Karibik-BVI/gallery/DSC_0353_695.webp', alt: 'Mann klettert auf eine über den Strand geneigte Palme' },
      { src: '/images/packages/Karibik-BVI/gallery/DSC_0436_774.webp', alt: 'Besucher am Steg vor dem Schild des Anegada Reef Hotel' },
      { src: '/images/packages/Karibik-BVI/gallery/DSC_0889_150.webp', alt: 'Piratenflaggen-Handtuch „The Baths, Virgin Gorda“ hängt zwischen Bäumen' },
      { src: '/images/packages/Karibik-BVI/gallery/DSC_0905_1234.webp', alt: 'Weiße Sandbucht zwischen den Granitfelsen von The Baths' },
      { src: '/images/packages/Karibik-BVI/gallery/DSC_0927_1256.webp', alt: 'Besucher zwischen den Granitfelsen von The Baths, im Hintergrund Palmen' },
      { src: '/images/packages/Karibik-BVI/gallery/DSC_1014_144.webp', alt: 'Mann balanciert auf einem Felsen bei The Baths auf Virgin Gorda' },
    ],
  },
  ...
  // ─────────────────────────────────── GRIECHENLAND ───────────────────────────────────
  {
    ...
    gallery: [
      ...
      { src: '/images/packages/Griechenland/gallery/20181008_184812.webp', alt: 'Segeln in Griechenland' },
  ...
  // ─────────────────────────────────── GRENADINEN ───────────────────────────────────
  {
    ...
    cardImg: '/images/packages/Karibik-Grenadinen/gallery/Tobago.webp',
    heroImg: '/images/packages/Karibik-Grenadinen/gallery/Tobago.webp',
    price: '900',
    priceNote: '7 Tage',
    tags: ['Freunde', 'Entdecker'],
    ...
    gallery: [
      { src: '/images/packages/Karibik-Grenadinen/gallery/Tobago.webp', alt: 'Tobago Cays' },
      { src: '/images/packages/Karibik-Grenadinen/gallery/Kat_overfly.webp', alt: 'Katamaran von oben' },
      { src: '/images/packages/Karibik-Grenadinen/gallery/IMG_6907B.webp', alt: 'Reihe von Cocktails bei Sonnenuntergang an Deck der Yacht' },
      { src: '/images/packages/Karibik-Grenadinen/gallery/sundowner.webp', alt: 'Sundowner' },
      ...
      { src: '/images/packages/Karibik-Grenadinen/gallery/Wallilabou2.webp', alt: 'Piratenstatuen und Schild am Eingang zur Wallilabou Bay' },
      { src: '/images/packages/Karibik-Grenadinen/gallery/Wallilabou1.webp', alt: 'Filmkulisse von Fluch der Karibik in der Wallilabou Bay' },
    ],
  },
  ...
  // ─────────────────────────────────── KORNATEN ───────────────────────────────────
  {
    ...
    gallery: [
      { src: '/images/packages/Kornaten/gallery/Mono Kornaten.webp', alt: 'Segelyacht in den Kornaten' },
      { src: '/images/packages/Kornaten/gallery/Dugi Otok.webp', alt: 'Dugi Otok' },
      { src: '/images/packages/Kornaten/gallery/Dugi Otok Wrack.webp', alt: 'Wrack bei Dugi Otok' },
      { src: '/images/packages/Kornaten/gallery/image (99).jpg', alt: 'Frau liest entspannt an Deck, im Hintergrund eine weitere Segelyacht' },
      { src: '/images/packages/Kornaten/gallery/image (6)-krka.webp', alt: 'Die Wasserfälle im Nationalpark Krka' },
      { src: '/images/packages/Kornaten/gallery/zadar-bei-yacht-urlaub.jpg', alt: 'Zadar' },
      { src: '/images/packages/Kornaten/gallery/image (6).webp', alt: 'Zwei Segelyachten bei Sonnenuntergang vor Anker' },
      { src: '/images/packages/Kornaten/gallery/image (93).jpg', alt: 'Crew schwimmt im offenen Meer neben der Yacht' },
      { src: '/images/packages/Kornaten/gallery/20180909_131842.webp', alt: 'Blick vom Bug der Yacht auf eine türkisblaue Bucht mit Sandstrand' },
    ],
  },
  ...
  // ─────────────────────────────────── ISTRIEN ───────────────────────────────────
  {
    ...
    gallery: [
      ...
      { src: '/images/packages/Istrien/gallery/sophie.webp', alt: 'Segelurlaub in Istrien' },
      { src: '/images/packages/Istrien/gallery/Rab.webp', alt: 'Rab' },
      { src: '/images/packages/Istrien/gallery/Amphitheater.jpg', alt: 'Amphitheater Pula' },
      { src: '/images/packages/Istrien/gallery/Istrien.webp', alt: 'Istrien' },
      { src: '/images/packages/Istrien/gallery/Krk.webp', alt: 'Krk' },
      { src: '/images/packages/Istrien/gallery/image (13).webp', alt: 'Kvarner Bucht' },
      { src: '/images/packages/Istrien/gallery/Kleine Insel somewhere.webp', alt: 'Kleine Insel' },
      { src: '/images/packages/Istrien/gallery/mali-losinj-2295423_1920.webp', alt: 'Mali Lošinj' },
    ],
  },
]
