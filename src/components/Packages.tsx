...
export const packages: Package[] = [
  ...
  // ─────────────────────────────────── KARIBIK BVI ───────────────────────────────────
  {
    ...
    gallery: [
      ...
      { src: '/images/packages/Karibik-BVI/gallery/1495014128.jpg', alt: 'Schnorchlerin unter Wasser vor einer Felsküste in der Karibik' },
  ...
  // ─────────────────────────────────── KORNATEN ───────────────────────────────────
  {
    ...
    gallery: [
      ...
      { src: '/images/packages/Kornaten/gallery/image (6).jpg', alt: 'Die Wasserfälle im Nationalpark Krka' },
      { src: '/images/packages/Kornaten/gallery/zadar-bei-yacht-urlaub.jpg', alt: 'Zadar' },
      { src: '/images/packages/Kornaten/gallery/image (6).png', alt: 'Zwei Segelyachten bei Sonnenuntergang vor Anker' },
      { src: '/images/packages/Kornaten/gallery/image (93).jpg', alt: 'Crew schwimmt im offenen Meer neben der Yacht' },
      { src: '/images/packages/Kornaten/gallery/20180909_131842.jpg', alt: 'Blick vom Bug der Yacht auf eine türkisblaue Bucht mit Sandstrand' },
    ],
  },
